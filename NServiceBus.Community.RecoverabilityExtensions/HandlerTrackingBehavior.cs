...
class HandlerTrackingBehavior : Behavior<IInvokeHandlerContext>
{
    ...
    public override async Task Invoke(IInvokeHandlerContext context, Func<Task> next)
    {
        ...
        catch (Exception e)
        {
            ...
            //TODO: this approach only takes the failing handler's config into account. A more sophisiticated approach should take into account the config of all invoked handlers so far and select the "lowest" applicable configuration.
